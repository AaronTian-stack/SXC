...
foreach (_tbb_component ${TBB_FIND_COMPONENTS})
    ...
    find_library(_tbb_release_lib
        NAMES lib${_tbb_component}${_bin_version}.${_${_tbb_component}_bin_version}.dylib
        PATHS ${_tbb_root}
    ...
    if (NOT TBB_FIND_RELEASE_ONLY)
        find_library(_tbb_debug_lib
            NAMES lib${_tbb_component}${_bin_version}_debug.${_${_tbb_component}_bin_version}.dylib
            PATHS ${_tbb_root}
            PATH_SUFFIXES "lib/${_tbb_intel_arch}/${_tbb_subdir}" "lib${_tbb_arch_suffix}/${_tbb_subdir}" "lib${_tbb_arch_suffix}" "lib"
            NO_DEFAULT_PATH
        )
